window.onload = function () {
  ...
  console.log("is 4 prime? " + myPrimeChecker(4));
  console.log("myPrimeChecker" + myPrimeChecker);
  ...
  var finalMarks = [89, 71.5, 43, 66.25, 16];
  var sortedMarks = finalMarks.sort(ascending());
  ...
  var comment = "I brought this for $100 at Bobmart";
  ...
  console.log("size: " + firstNameField.size);
  ...
  //window.alert('This is still annoying');
};  